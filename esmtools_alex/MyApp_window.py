...
ui_path = pkg_resources.resource_filename('esmtools_alex', 'ui/elio_gui_4.ui')
...
def main2 (db=None,  RE=None, print_summary=None, scan_time=None,  scan_esm=None, motors = None, detectors=None,  Beamline = None,  BeamSource=None,  Eph=None):
...
def main (db=None,  RE=None, print_summary=None, scan_time=None,  scan_esm=None, motors = None, detectors=None,  Beamline = None,  BeamSource=None,  Eph=None):
    ...
    #print(*uic.loadUiType(ui_path))
    #threadpool = QtCore.QThreadPool()
    #worker = Worker(main2,RE,print_summary,scan_time,scan_esm,motors,detectors,Beamline,BeamSource,Eph)
    #worker.signals.trigger.connect(print_trigger)
    #threadpool.start(worker)
    #sys.exit(app.exec_())
